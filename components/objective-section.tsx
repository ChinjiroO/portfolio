  ...
  return (
    <Parallax offset={50}>
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <div className="flex overflow-hidden h-fit shadow-xl justify-center items-center font-bold max-w-5xl py-10 px-5 mx-5 bg-midnight-200 rounded-xl">
          <Parallax offset={25}>
            <p className="text-3xl py-5 text-green-101">Objective</p>
            <p className="font-sans font-normal text-slate-100">
