...
const ContactSection: React.FC = () => {
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 min-h-[500px] w-screen items-center font-bold max-w-5xl px-5 my-5 text-slate-100 gap-8">
			<div className="h-full text-2xl md:px-8">
				<Parallax offset={75}>
