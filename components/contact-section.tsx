...
const ContactSection: React.FC = () => {
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 w-screen items-center font-bold max-w-5xl px-5 text-slate-100 gap-4 pb-20 md:pb-0">
			...
			<Parallax offset={75}>
				<div className="flex flex-col gap-4 rounded-xl  font-sans font-medium text-lg p-8 border border-gray-600">
					...
					<div className="flex flex-col items-end w-full gap-2">
						<button className="w-full sm:w-auto px-4 py-2 rounded-md border border-green-101 text-green-101 hover:bg-gradient-to-tr from-blue-101 hover:border-transparent to-green-101 hover:text-white shadow-md text-base transition-all hover:transition-all">
							Send Message
						</button>
					</div>
				</div>
